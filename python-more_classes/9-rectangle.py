...
methods to calculate area, perimeter, and represent the rectangle
as a string. It tracks the number of instances and includes methods
for comparison and creating squares.
"""
...
class Rectangle:
    ...
    Methods:
        ...
        square(cls, size): Returns a new Rectangle instance with width and
